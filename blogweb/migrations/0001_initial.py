...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='UserInfo',
            fields=[
                ('id', models.UUIDField(auto_created=True, default='2e72d140b3c511ecb209acbc329b8456', primary_key=True, serialize=False)),
                ...
                ('is_deleted', models.BooleanField(max_length=10, verbose_name='the flag of deleted or not; 0 means not deleted,1 means deleted')),
                ...
                ('token', models.UUIDField(blank=True, default='2e736d98b3c511ecaf06acbc329b8456', null=True, verbose_name='user token')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nav_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='blogweb.navigationcategory', verbose_name='website navigation category')),
            ],
            options={
                'verbose_name_plural': 'Navigation categories',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blogweb.article', verbose_name='comment on the corresponding article')),
